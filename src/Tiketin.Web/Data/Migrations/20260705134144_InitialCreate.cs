        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    sla_response_minutes = table.Column<int>(type: "integer", nullable: false),
                    sla_resolution_minutes = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_kb_articles_users_author_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    satisfaction_rating = table.Column<short>(type: "smallint", nullable: true),
                    satisfaction_note = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
                    created_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false, defaultValueSql: "now()"),
                    updated_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    old_value = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: true),
            ...
            // Full-text search over KB articles (Indonesian dictionary). Expression
            // indexes of this shape cannot be modeled by EF, hence raw SQL.
            migrationBuilder.Sql("""
                CREATE INDEX ix_kb_articles_search ON kb_articles
                USING GIN (to_tsvector('indonesian', title || ' ' || body_markdown));
                """);
        }
